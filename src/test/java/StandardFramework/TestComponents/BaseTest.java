...
import StandaredFramework.PageObject.eComerce;
...
public class BaseTest 
{
	...
	public HashMap<Object, Object> getData(String filepath) throws IOException
	{
		//json to String
		...
		HashMap<Object,Object> data=(HashMap<Object, Object>) mapper.readValue(jsonfile, new TypeReference<List<HashMap<Object,Object>>>(){
		}).get(0);
		return (HashMap<Object, Object>)data;
	}
	@BeforeMethod(alwaysRun=true)
	public eComerce Launch() throws IOException
	{
		driver=intialization();
		driver.get("https://www.saucedemo.com/");
		eC=new eComerce(driver);
		return eC;
	}
